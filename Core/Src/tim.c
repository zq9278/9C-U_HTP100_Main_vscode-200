...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspInit 0 */
    ...
    /* A WS2812 update is exactly one frame.  Circular DMA can restart the
     * frame before the completion callback has stopped TIM16, which is
     * visible as flicker while breathing updates are being sent. */
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    /* Keep DIN low while TIM16 is stopped and while the LED rail starts. */
